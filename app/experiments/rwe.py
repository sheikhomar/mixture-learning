...
def no_bias_multi_step_var_02() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4, 5, 7, 10]:
        variance = 10
        for n_dim in [100, 50, 10]:
            params = generate_default_experiment()
...
def no_bias_multi_step_var_03() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4, 5, 7, 10]:
        variance = 10
        for n_dim in [300, 200]:
            params = generate_default_experiment()
            params["n_dim"] = n_dim
            params["n_steps"] = n_step
            params["min_distance"] = np.power(n_dim, 1/4) * (3 + np.log10(n_dim)) * (variance * n_dim)
...
def no_bias_few_steps_01() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4]:
        for n_dim in [10, 50, 100, 200, 300]:
            params = generate_default_experiment()
            params["n_dim"] = n_dim
            params["n_steps"] = n_step
            params["min_distance"] = np.power(n_dim, 1/4) * (0.0 + np.log(n_dim))
            params["bias_factor"] = 1
            params["variance"] = 1
            yield from_dict(
                data_class=RandomWalkEmbeddingExperimentParams, 
...
def no_bias_few_steps_02() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4]:
        for n_dim in [10, 50, 100, 200, 300]:
            params = generate_default_experiment()
            params["n_dim"] = n_dim
            params["n_steps"] = n_step
            params["min_distance"] = np.power(n_dim, 1/4)
            params["bias_factor"] = 1
            params["variance"] = 1
            yield from_dict(
                data_class=RandomWalkEmbeddingExperimentParams, 
...
def no_bias_few_steps_03() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4]:
        for n_dim in [10, 50, 100, 200, 300]:
            params = generate_default_experiment()
            params["n_dim"] = n_dim
            params["n_steps"] = n_step
            params["min_distance"] = np.power(n_dim, 1/4)* (0.0 + np.log10(n_dim))
            params["bias_factor"] = 1
            params["variance"] = 1
            yield from_dict(
                data_class=RandomWalkEmbeddingExperimentParams, 
...
def no_bias_few_steps_04() -> Generator[RandomWalkEmbeddingExperimentParams, None, None]:
    for n_step in [2, 3, 4]:
        for n_dim in [10, 50, 100, 200, 300]:
            params = generate_default_experiment()
            params["n_dim"] = n_dim
            params["n_steps"] = n_step
            params["min_distance"] = np.power(n_dim, 1/8)
            params["bias_factor"] = 1
            params["variance"] = 1
            yield from_dict(
                data_class=RandomWalkEmbeddingExperimentParams, 
...
AVAILABLE_EXPERIMENTS = [
    ...
    no_bias_multi_step_var_02,
    no_bias_multi_step_var_03,
    no_bias_few_steps_01,
    no_bias_few_steps_02,
    no_bias_few_steps_03,
    no_bias_few_steps_04,
]
